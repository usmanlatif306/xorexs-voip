        ...
        <div class="col-xl-8 col-md-12">
            <div class="card">
                <div class="card-header">
                    ...
                    <span class="text-muted">Get 15% Off on
        ...
        <div class="col-xl-4 col-md-12">
            ...
            <div class="card quater-card">
                <div class="card-block">
                    ...
                    <h5>87</h5>
                    <p class="text-muted">
                        Online Revenue<span class="f-right">80%</span>
                    </p>
                    <div class="progress">
                    ...
                    <p class="text-muted">
                        Offline Revenue<span class="f-right">50%</span>
                    </p>
                    <div class="progress">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="{{ asset('admin/assets/images/avatar-4.jpg') }}" alt="user image"
                                                class="
                                                img-radius img-40
                                                align-top
                                                m-r-15
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="{{ asset('admin/assets/images/avatar-5.jpg') }}" alt="user image"
                                                class="
                                                img-radius img-40
                                                align-top
                                                m-r-15
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="{{ asset('admin/assets/images/avatar-3.jpg') }}" alt="user image"
                                                class="
                                                img-radius img-40
                                                align-top
                                                m-r-15
                                ...
                                <tr>
                                    <td>
                                        ...
                                        <div class="d-inline-block align-middle">
                                            <img src="{{ asset('admin/assets/images/avatar-2.jpg') }}" alt="user image"
                                                class="
                                                img-radius img-40
                                                align-top
                                                m-r-15
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-header-right">
                        <ul class="list-unstyled card-option">
                            <li>
                                <i class="fa fafa-wrench open-card-option"></i>
                            </li>
                            <li>
                                <i class="fa fa-window-maximize full-card"></i>
                            </li>
                ...
                <div class="card-block">
                    ...
                    <div class="align-middle m-b-30">
                        <img src="{{ asset('admin/assets/images/avatar-1.jpg') }}" alt="user image"
                            class="img-radius img-40 align-top m-r-15" />
                        <div class="d-inline-block">
                            <h6>David Jones</h6>
                            <p class="text-muted m-b-0">Developer</p>
